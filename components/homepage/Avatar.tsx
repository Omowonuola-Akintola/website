...
const Avatar = () => {
  ...
  return (
    <div
      className="z-1 hover:z-2 scale-100 transition-all duration-200 ease-out hover:scale-[1.05]"
      style={{ perspective: '900px' }}
      ref={ref}
    >
      <div style={style} className="max-h-[600px] overflow-hidden rounded-md transition-all duration-200 ease-out">
