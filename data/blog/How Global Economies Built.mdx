---
title: 'How Economies Successfully Built Thriving Commercial EO Industries'
...
his perspective aligns with Peter Thiel's critique (or my interpretation of it) in "Zero to One," where he questions the language often use to 
...
Both thinkers converge on a powerful insight: starting late doesn’t necessarily mean falling behind. In fact, it can offer a strategic advantage 
allowing to begin with greater knowledge, more advanced tools, and fewer established constraints. As Santayana famously noted, 
...
valuable lessons for Africa's emerging commercial EO sector. History is now our tool for building a better future.
...
attempted to privatize the [Landsat program](https://landsat.gsfc.nasa.gov/satellites/history/), a long-term civil EO initiative launched by NASA in 1972. While the program began as an experimental effort, 
...
WorldView-2 (2009), WorldView-3 entering the market. However, commercial imagery was still expensive, and the ecosystem for scalable, downstream services wasn’t mature. As a result, 
few startups existed that could build directly EO data. Most commercial EO companies also generated revenue through partnerships with foreign governments that couldn’t afford their 
...
high-resolution imagery. This led to an explosion in analytics and value-added services (VAS) including crop monitoring, deforestation alerts, urban growth mapping, and more with agencies 
now funding down stream layers. Many early-stage Earth Observation (EO) startups in the U.S. received funding from government agencies, particularly through [Small Business Innovation Research](https://www.sbir.gov/about)
...
of venture capital. By the early 2010s, VC firms began recognizing that EO could bring in some more values. Companies like [Planet Labs](https://techcrunch.com/2013/12/18/planet-labs-52m-yuri-milner/), Descartes Labs, and Orbital Insight were among the first 
...
These included new satellites and operators Disaster Moninoting Constellation in 2002(UK), TerraSAR-X in 2007(operated by DLR and Infoterra, Germany), COSMO-SkyMed in 2007(operated by the Italian Space Agency, Italy), 
RapidEye in 2008(operated by RapidEye AG, Germany),among others. Despite these additions, the high cost of data and relatively low commercial demand limited the growth of the commercial
EO sector in Europe during this time.
...
Today, Europe hosts over 100 EO-related startups and SMEs, with the EO data and services market expected to exceed €3 billion annually by the mid-2020s, according to European Commission projection
...
Through its leadership in space policy and its role in shaping Agenda 2063, the AU has been instrumental in enabling programs like GMES & Africa and EO AFRICA.  Together, these initiatives embody the AU’s vision of leveraging space science 
...
Crucially, these programs now align with the broader ambitions outlined in the [African Space Strategy 2016](https://au.int/sites/default/files/documents/37434-doc-au_space_strategy_isbn-electronic.pdf). This strategy positions space science and technology — including Earth Observation — as a cornerstone for achieving Agenda 2063, the AU’s
...
However, to fully capitalize on their impact, the next step is clear, these efforts must be better connected to market mechanisms, entrepreneurship, and national procurement frameworks that create sustainable demand for EO-based services 
across sectors. What’s needed now is to strengthen the link between this public infrastructure and the commercial market, enabling local startups, SMEs, and innovators to build viable EO businesses that address Africa’s unique challenges and opportunities.
...
This calls for a collective responsibility to help decision-makers understand not just what EO can do, but why it matters.
