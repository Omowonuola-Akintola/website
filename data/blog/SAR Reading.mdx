...
Synthetic Aperture Radar : A sort of process where we use the electromagnetic wavelengths with microwave energy to
...
In remote sensing, what matters is how different wavelength of the electromagnetic spectrum can or cannot pass through Earth’s atmosphere.
...
This can only make sense when we try to understand how the microwave camera works. Need a few weeks on this
