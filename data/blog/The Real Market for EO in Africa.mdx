---
title: 'The Real Market For Earth Observation in Africa'
...
Earth Observation (EO) is often talked about as if it's a single product, but in reality, EO operates across a spectrum of use cases, each
with different requirements, value potential, and commercial models. A useful way to understand this is the “5 Ms of EO”: Mapping, Measuring, 
Monitoring, Modeling, and Managing proposed by TerraWatch Space. I believe this framework is helpful for understanding the different ways EO 
creates value and for identifying which of those can already support commercial business models, and which still depend on policy and incentives 
to become viable.
...
In fact, many of the commercial examples shared in this article reflect EO-backed services that have already been deployed across Africa. These cases 
...
Agriculture has always been at the core of African economies. Over 60% of the continent's population is engaged in farming. It remains the most mature and immediate opportunity 
...
The World Bank warns that climate change could reduce staple crop yields in Sub-Saharan Africa by up to 20% by 2050. As climate change disrupts planting cycles and food security becomes a 
...
- **Why it matters**: Offers field-scale insights using public data (Sentinel-1/2, MODIS) for parametric insurance and advisory.
- **Used in Africa**: Partnered in East African pilots for **weather-index insurance** and resilience programs.
...
- **Used in Africa**: Yes — partnered with **African Risk Capacity (ARC) and the Wordl Food Programme(WFP) in [Sudan](https://www.floodbase.com/case-studies/sudan) and [DR Congo].(https://www.floodbase.com/case-studies/sudan)
...
Validation for climate finance, forestry and conservation to verify land use, and infrastructure to help banks monitor project exposure. These use cases are already in motion, and in many cases, commercially driven.
...
**[UrbanFootprint](https://urbanfootprint.com/about/)**
...
and unable to scale. At the same time, it’s important to remember that many EO use cases are already possible today using free, open satellite data from platforms like Sentinel and Landsat. Sectors 
like agriculture, disaster response, and finance already have clear entry points. The next step is to build tools and services that adapt to technical constraints, simplify delivery, and speak directly 
to the needs of users on the ground. But building a viable EO market in Africa also means understanding our own markets. The market structure, purchasing power, and demand patterns across the continent 
are fundamentally different. Companies are already solving real problems often without knowing that EO could make those solutions faster, cheaper, or smarter.  The opportunity isn’t just to introduce new 
technology, but to prove that EO can reduce operating costs and improve outcomes in ways that make commercial sense.
