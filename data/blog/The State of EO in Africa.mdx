...
Recently, I was researching Cloud-Native Geospatial (CNG) formats for EO analysis with the intention of 
creating a technical blog post. My goal was to develop a lightweight Python workflow for “commercial businesses” in 
...
Does a commercial EO industry even exist in Africa? 
...
While EO is recognized as a powerful tool for decision-making, the commercial landscape remains undeveloped, with most initiatives driven 
...
This section draws insights from two industry reports, one from 2016 and another from 2024.
...
- The African private EO sector has grown steadily over the past two decades, but is still dominated by small 
and medium-sized enterprises (SMEs).
- Most local EO companies operate in the downstream sector—GIS consulting, value-added services, and mapping—while 
high-value EO analytics remain dominated by international firms.
...
This trend is concerning because economic value in EO is increasingly derived from analytics, machine learning applications, 
and decision-making tools. Yet, local businesses remain stuck in providing services, rather than developing EO-driven business 
intelligence platforms or industry-specific applications.

**Who Owns and Controls Africa’s EO Data?***

A 2024 study by Nakalembe et al. examined the ownership and control of EO data across Africa, and the findings were stark:
...
- Most companies engage in GIS mapping, training, data resell, and data visualization.
