...
and medium-sized enterprises (SMEs). Most companies generate annual revenues below $500,000, with only a few 
surpassing this range and an even smaller number reaching beyond $1 million.
- Most local EO companies operate in value-added services, working directly with raw data to develop specialized
products for various applications, as well as in downstream services, where satellite data is integrated into broader business
operations rather than being the core focus, and consultancy. High-value EO analytics remain dominated by international firms.
...
Yet, local businesses remain stuck in providing services, rather than providing advanced EO analytics and intelligence platforms.
...
- Most companies engage in GIS mapping, training, data resell.
